...
from base import SenseEngine, PolicyEngine, InformationSet, SimulationEngine, EngineSpec
...
class KnightPolicyEngine(PolicyEngine):
    def __init__(self, sense_engine: SenseEngine, eval_engine: SimulationEngine, color):
        engine_spec = EngineSpec(sense_engine, eval_engine, None)
        super(KnightPolicyEngine, self).__init__()
